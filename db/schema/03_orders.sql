...
CREATE TABLE orders (
  ...
  start_time TIMESTAMPTZ NOT NULL, /* this time starts when the use click submit on the page */
  end_time TIMESTAMPTZ /* should be set once the order is completed/delivered */
);
